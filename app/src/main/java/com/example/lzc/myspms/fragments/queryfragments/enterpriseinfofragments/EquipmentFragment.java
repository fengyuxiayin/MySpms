...
public class EquipmentFragment extends BaseFragment  {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Log.e(TAG, "onActivityCreated: "+ " qyid " + qyId + " zqjlId " + zqjlId + " jclx " + jclx + " jcId " + jcId);
        initView();
        initData();
        initListener();
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.e(TAG, "onActivityResult: equip" );
        if (intentResult != null) {
            if (intentResult.getContents() == null) {
                Toast.makeText(getContext(), "内容为空或取消了扫描", Toast.LENGTH_LONG).show();
            } else {
