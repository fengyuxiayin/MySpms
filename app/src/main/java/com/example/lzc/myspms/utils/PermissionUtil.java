...
public class PermissionUtil {
    ...
    * 常用的权限
     ...
     Manifest.permission.ACCESS_COARSE_LOCATION //gps模糊位置
     Manifest.permission.ACCESS_FINE_LOCATION   //gps精确位置
    ...
    * */
    ...
    public static void checkAndRequestMorePermissions(Context context, String[] permissions, int requestCode) {
        ...
        Log.e(TAG, "checkAndRequestMorePermissions: "+permissionList.size() );
