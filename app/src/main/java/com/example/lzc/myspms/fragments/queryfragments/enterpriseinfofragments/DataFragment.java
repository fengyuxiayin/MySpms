...
public class DataFragment extends BaseFragment  {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Log.e(TAG, "onActivityCreated: " + jcId);
    ...
    private void initView() {
        ...
        btnSave = (Button) view.findViewById(R.id.fragment_project_btn_save);
        btnSave.setText("添加资料类项目");
        tvBottom = (TextView) view.findViewById(R.id.fragment_project_tv);
        //设置listView的模式和加载文字
