...
public class FireFragment extends BaseFragment  {
    public static final String TAG = FireFragment.class.getSimpleName();
    private String qyId;
    private String jcId;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Log.e(TAG, "onActivityCreated: " + "qyId " + qyId + "jcId " + jcId + "zqjlId " + zqjlId + "jclx " + jclx);
        initView();
        initData();
        initListener();
    }
