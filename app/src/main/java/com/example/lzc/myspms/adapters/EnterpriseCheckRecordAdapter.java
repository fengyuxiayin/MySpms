...
public class EnterpriseCheckRecordAdapter extends BaseAdapter {
    private  final String TAG = this.getClass().getSimpleName();
    private List<QueryCheckRecordModel.QueryCheckRecordMsgModel.ListBean> data;
    private Context context;
    private LayoutInflater inflater;
    public EnterpriseCheckRecordAdapter(List<QueryCheckRecordModel.QueryCheckRecordMsgModel.ListBean> data, Context context) {
        if (data!=null) {
            this.data = data;
        }else{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textViewChecker.setText(data.get(position).getSsdwmc());
        return convertView;
    }
