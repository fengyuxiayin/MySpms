...
//        String regex = "(\\(\\d{3,4}\\)|\\d{3,4}-|\\s)?\\d{7}";
     ...
     * @return
     */
    public static boolean isNumberNine(String str) {
        String regex = "^\\d{9}$";
//        String regex = "(\\(\\d{3,4}\\)|\\d{3,4}-|\\s)?\\d{7}";
        return match(regex, str);
    }
    ...
    public static boolean isLatitude(String str) {
        String regex = "[\\-\\+]?(0?\\d{1,2}\\.\\d{6}|1[0-7]?\\d{1}\\.\\d{4,6}|180\\.0{6})";
//        String regex = "(\\(\\d{3,4}\\)|\\d{3,4}-|\\s)?\\d{7}";
        return match(regex, str);
    }
    /**
...
//        String regex = "[\\-\\+]?([0-8]?\\d{1}\\.\\d{6}|90\\.0{6})";
        String regex = "(-|\\\\+)?(90.0{4,6}|([1-9]\\\\d{1}.\\\\d{4,6}|(\\\\d{1}.\\\\d{4,6})))";
//        String regex = "(\\(\\d{3,4}\\)|\\d{3,4}-|\\s)?\\d{7}";
        return match(regex, str);
    }
    /**
     ...
     * @return
     */
    public static boolean isLengthNine(String str) {
