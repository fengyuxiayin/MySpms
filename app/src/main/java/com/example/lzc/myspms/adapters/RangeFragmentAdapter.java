 ...
 */
public class RangeFragmentAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public RangeFragmentAdapter(List<CommunityInfoQueryModel.CommunityInfoQueryMsgModel.ListBean> data, Context context, Activity activity) {
        if (data == null) {
